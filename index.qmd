...
Crash %>%
  ...
  theme_light()
```
Our third visualization is a histogram showing the frequency of fatal injuries across vehicle years. Fatal injuries occurred most frequently in cars made around 2006. While there isn't too much of a skewed distribution of fatal injuries on either side of the vehicle year spectrum, this graph does demonstrate that more fatal injuries occur in older vehicles. Though crashes in new vehicles do still result in fatal injuries, this histogram shows that the highest frequency of fatal injuries occurs before the year 2019. This might suggest that newer vehicles are being built with greater safety standards, but also points to the need to update the safety infrastructure of older cars on the road. 
